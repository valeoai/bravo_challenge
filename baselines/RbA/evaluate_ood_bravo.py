...
from datasets.segment_me_if_you_can import RoadAnomaly21
...
def run_evaluations(model, dataset, model_name, dataset_name, out_path):
    """
    ...
    evaluator.compute_anomaly_scores(
        loader=loader,
        device=DEVICE,
        return_preds=False,
        upper_limit=999999,
...
def main():
    ...
    for model_name in models_list:
        ...
        for dataset_name, dataset in dataset_group:
            ...
            results[dataset_name] = run_evaluations(model, dataset, model_name, dataset_name, out_path)
